...
<html>
	...
	<body>
		                    	...
		                    	<table class="goods_table">
		                    		...
		                    		<c:forEach items="${list}" var="list">
			                    		<tr>
			                    			...
			                    			<%-- 사용자가 '상품 목록(goodsManage.jsp) 페이지'에서 상품 이름을 클릭하였을때 
			                    											'상품 상세 조회(goodsDetail.jsp) 페이지'로 이동할 수 있도록 --%>
		...
		<script>
			...
			let searchForm = $('#searchForm');   //검색창 폼
			let moveForm = $('#moveForm');   //페이징 데이터 폼
			...
			$(".move").on("click", function(e){
				...
				//페이징 데이터 폼에 클릭한 상품 이름 a 태그의 bookId 값 추가
